function PreprocessFmriFiles
%loads all participants .mat files and saves one preprocessed EventTimeStampTable
% per participant and all participants concatenated 

close all
clear;

% currentFolder = cd('../ParticipantsData');
% dataFolder = pwd;

currentFolder = what('ParticipantsData');
...
csvwrite('SARSPEICZVG_all_fMRI.csv', SARSPEICZVG_all);
